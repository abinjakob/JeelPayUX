...
sns.barplot(x=counts.index, y=100 * counts / counts.sum(), palette=[c[0], c[2], c[4]])
...
sns.barplot(x=counts.index, y=100 * counts / counts.sum(), palette=[c[0], c[1], c[2], c[3], c[4]])
plt.xticks(rotation=0)
plt.ylim(0,100)
plt.xlabel('')
plt.ylabel('percent (%)')
...
sns.barplot(x=counts.index, y=100 * counts / counts.sum(), palette=[c[0], c[2]])
plt.xticks(rotation=0)
plt.ylim(0,100)
plt.xlabel('')
plt.ylabel('percent (%)')
